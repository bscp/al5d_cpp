...
// {
//     { // NORMAL JOINT
//         al5d_cpp::JointBaseConfig config(0, 1, 2, 3, 4);
//         al5d_cpp::Joint joint(config);
...
// //        al5d_cpp::JointBaseConfig config(0, 1, 2, 4, 3);
// //        al5d_cpp::Joint joint(config);
// //
...
// //        al5d_cpp::JointBaseConfig config(0, 2, 1, 3, 4);
// //        al5d_cpp::Joint joint(config);
// //
